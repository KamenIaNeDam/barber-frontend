...
<Breadcrumb.Root >
    <Breadcrumb.List>
        ...
        <Breadcrumb.Item>
          <Breadcrumb.Link href="/admin/contact">Контакты</Breadcrumb.Link>
        </Breadcrumb.Item>
        <Breadcrumb.Separator />
        <Breadcrumb.Item>
          <Breadcrumb.Page>Контакт - {data.contact.title}</Breadcrumb.Page>
        </Breadcrumb.Item>
      </Breadcrumb.List>
</Breadcrumb.Root>
    <AdminContact contact={data.contact}  form={data.form}/>
